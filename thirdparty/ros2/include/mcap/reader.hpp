// Vendored (read-path only) from https://github.com/foxglove/mcap,
// tag releases/cpp/v2.1.3 (commit 1420296ffcfdcde4b6894c0c1aba0ad083f93dde).
// Upstream is MIT licensed; see thirdparty/ros2/include/mcap/LICENSE.
#pragma once
